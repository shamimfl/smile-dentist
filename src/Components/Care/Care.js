...
const Care = () => {
    return (
        <div className="bg-base-100 mt-10 mb-10 lg:px-20 p-5">
            <div className=" lg:flex items-center  justify-between gap-20">
                <img src="https://img.freepik.com/free-vector/teeth-dental-care-medical-background_1017-17395.jpg?w=740&t=st=1667901365~exp=1667901965~hmac=af73c35db6ca9fbc27a23f4f5ac63309403547a0fad81d8959f3051d8eef50de" className="max-w-md rounded-lg shadow-2xl" />
